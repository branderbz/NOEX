...
/**
 * Service for managing connection and data communication with a 2 GATT servers hosted on
...
public class BluetoothLeService extends Service {
    ...
    //used to switch which ble device is sending info to the phone
    ...
    private final BluetoothGattCallback mGattCallbackTwo = new BluetoothGattCallback() {
        ...
        //this is the function that is called when the phone wants information
        @Override
        public void onCharacteristicRead(BluetoothGatt gatt,
                                         BluetoothGattCharacteristic characteristic,
                                         int status) {
    ...
    // is called when activity needs update from BLE devices
